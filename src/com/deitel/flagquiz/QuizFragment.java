...
public class QuizFragment extends Fragment 
{
   ...
   private int totalCorrectGuessInFirst;
   private int score;
      ...
      Bundle savedInstanceState)
   {
      ...
      wiki = (Button) view.findViewById(R.id.wikiButton);
      next = (Button) view.findViewById(R.id.nextPage);
      wiki.setOnClickListener(wikiButtonListener);
      next.setOnClickListener(nextFlagListener);
   ...
   private OnClickListener nextFlagListener = new OnClickListener() {
   ...
   private OnClickListener guessButtonListener = new OnClickListener() 
   {
      ...
      public void onClick(View v) 
      {
         ...
         if (guess.equals(answer)) // if the guess is correct
         {
        	 if(isFirst==true){
        		 score+=10;
        		 totalCorrectGuessInFirst++;
        	 }
        	 else{
        		 score+=5;
        	 }
            ++correctAnswers; // increment the number of correct answers
            urlString = getString(R.string.wikiURL)+Uri.encode(answer, "UTF-8");
                  ...
                  new DialogFragment()
                  {
                     ...
                     public Dialog onCreateDialog(Bundle bundle)
                     {
                        ...
                        builder.setMessage(
                           ...
                           totalGuesses, (1000 / (double) totalGuesses), totalCorrectGuessInFirst, score));
